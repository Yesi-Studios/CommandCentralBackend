...
namespace CommandCentral.Logging.Loggers
{
    class ConsoleLogger : ILogger
    {
        ...
        {
            Console.WriteLine("[{0}] [{1}] : {2}\n\tToken : {3}\n\tCaller Member Name : {4}\n\tCaller Line Number : {5}\n\tCaller File Path : {6}".With(DateTime.UtcNow, MessageTypes.CRITICAL, message, Utilities.ToSafeString(token), callerMemberName, callerLineNumber, callerFilePath));
        }
        ...
        {
            Console.WriteLine("[{0}] [{1}] : {2}\n\tToken : {3}\n\tCaller Member Name : {4}\n\tCaller Line Number : {5}\n\tCaller File Path : {6}".With(DateTime.UtcNow, MessageTypes.DEBUG, message, Utilities.ToSafeString(token), callerMemberName, callerLineNumber, callerFilePath));
        }
        ...
        {
            Console.WriteLine("[{0}] [{1}] : {2}\n\tToken : {3}\n\tException Details : {4}\n\tCaller Member Name : {5}\n\tCaller Line Number : {6}\n\tCaller File Path : {7}".With(DateTime.UtcNow, MessageTypes.ERROR, message, Utilities.ToSafeString(token), ex.ToString(), callerMemberName, callerLineNumber, callerFilePath));
        }
        ...
        {
            Console.WriteLine("[{0}] [{1}] : {2}".With(DateTime.UtcNow, MessageTypes.INFORMATION, message));
        }
        ...
        {
            Console.WriteLine("[{0}] [{1}] : {2}\n\tToken : {3}\n\tCaller Member Name : {4}\n\tCaller Line Number : {5}\n\tCaller File Path : {6}".With(DateTime.UtcNow, MessageTypes.WARNING, message, Utilities.ToSafeString(token), callerMemberName, callerLineNumber, callerFilePath));
        }
    }
}
