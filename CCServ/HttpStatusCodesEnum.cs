...
{
    /// <summary>
    /// This contains all of the valid http status codes used by command central.
    /// </summary>
    public enum HttpStatusCodes
    {
        /// <summary>
        /// Indicates that something about the parameters the client sent are not correct.
        /// </summary>
        [CorrespondingErrorType(ErrorType = ClientAccess.ErrorTypes.Validation)]
        ...
        /// </summary>
        [CorrespondingErrorType(ErrorType = ClientAccess.ErrorTypes.Fatal)]
        ...
        /// <summary>
        /// Indicates that the endpoint was found; however, it is not currently accepting requests.
        /// </summary>
        [CorrespondingErrorType(ErrorType = ClientAccess.ErrorTypes.Validation)]
        ServiceUnavailable = HttpStatusCode.ServiceUnavailable,
        /// <summary>
        /// Indicates that an action was attempted to be taken which ws forbidden.
        /// </summary>
        [CorrespondingErrorType(ErrorType = ClientAccess.ErrorTypes.Authorization)]
        Forbidden = HttpStatusCode.Forbidden,
        /// <summary>
        /// Indicates the client tried to take an action it was not authorized to do.
        /// </summary>
        [CorrespondingErrorType(ErrorType = ClientAccess.ErrorTypes.Authorization)]
