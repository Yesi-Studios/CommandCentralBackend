...
namespace CCServ.ClientAccess.Endpoints.Watchbill
{
    ...
    class WatchDayEndpoints
    {
        ...
        private static void LoadWatchDay(MessageToken token)
        {
            ...
            {
                throw new CommandCentralException("You failed to send a 'watchdayid' parameter.", ErrorTypes.Validation, System.Net.HttpStatusCode.BadRequest);
                return;
            }
            ...
            {
                throw new CommandCentralException("Your watch day id parameter's format was invalid.", ErrorTypes.Validation, System.Net.HttpStatusCode.BadRequest);
                return;
            }
            ...
            using (var session = DataAccess.NHibernateHelper.CreateStatefulSession())
            {
                using (var transaction = session.BeginTransaction())
                {
                    try
                    {
                        ...
                        {
                            throw new CommandCentralException("Your watch day's id was not valid.  Please consider creating the watch day first.", ErrorTypes.Validation, System.Net.HttpStatusCode.BadRequest);
                            return;
                        }
        ...
        private static void CreateWatchDays(MessageToken token)
        {
            ...
            {
                throw new CommandCentralException("You failed to send a 'watchdays' parameter.", ErrorTypes.Validation, System.Net.HttpStatusCode.BadRequest);
                return;
            }
            ...
            {
                throw new CommandCentralException("An error occurred while trying to parse your watch days.", ErrorTypes.Validation, System.Net.HttpStatusCode.BadRequest);
                return;
            }
        ...
        private static void UpdateWatchDay(MessageToken token)
        {
            ...
            {
                throw new CommandCentralException("You failed to send a 'watchday' parameter.", ErrorTypes.Validation, System.Net.HttpStatusCode.BadRequest);
                return;
            }
            ...
            {
                throw new CommandCentralException("An error occurred while trying to parse your watch day.", ErrorTypes.Validation, System.Net.HttpStatusCode.BadRequest);
                return;
            }
