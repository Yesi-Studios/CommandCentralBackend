...
namespace CCServ.Entities.ReferenceLists
{
    ...
    public static class AccountHistoryTypes
    {
        ...
        public static AccountHistoryType UsernameForgotten = new AccountHistoryType { Id = Guid.Parse("{80123747-55E3-40B2-A834-E31CBC2DEA72}"), Value = "Username Forgotten", Description = "The client indicated that he or she forgot the account's username, and it was emailed to the user." };
