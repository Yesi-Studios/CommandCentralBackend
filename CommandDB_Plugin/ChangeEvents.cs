...
namespace CommandCentral
{
    ...
    public static class ChangeEvents
    {
        ...
        public class ChangeEvent
        {
            ...
            public List<SpecialPermissionTypes> RequiredSpecialPermissions { get; set; }
                        ...
                        if (reader.HasRows)
                        {
                            while (await reader.ReadAsync())
                            {
                                result.Add(new ChangeEvent()
                                {
                                    ...
                                    RequiredSpecialPermissions = reader["RequiredSpecialPermissions"].ToString().Deserialize<List<SpecialPermissionTypes>>()
                                });
                            }
                        }
                    }
                            ...
                            if (reader.HasRows)
                            {
                                while (await reader.ReadAsync())
                                {
                                    result.Add(new ChangeEvent()
                                    {
                                        ...
                                        RequiredSpecialPermissions = reader.ToString().Deserialize<List<SpecialPermissionTypes>>()
                                    });
                                }
                            }
                        }
